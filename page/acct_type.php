...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/page/acct_type.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>กำหนดค่าเริ่มต้นหมวดบัญชีของแต่ละกองทุน</h1>
     <br/>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">ลำดับ</th>
                    <th class="col-center">ชื่อกองทุน</th>
                    <th class="col-right">fund_id</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
               <div class="form-group">
                <label class="col-sm-3 control-label" for="acctype_name">
                    ชื่อกองทุน <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="fund_id">
                    fund_id :
                </label>
                <div class="col-sm-9">
                    <input type="text" name="fund_id" class="form-control form-number" />
                </div>
            </div>
