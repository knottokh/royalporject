...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_fertilizer.js"></script>
    </head>
<body>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    <th class="col-center">fertilizer_formula</th>
                    <th class="col-center">brand</th>
                    <th class="col-right">amount</th>
                    <th class="col-right">cost</th>
                    <th class="col-right">price</th>
                    <th class="col-right">year_import</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            <div class="form-group">
                <label class="col-sm-3 control-label" for="fertilizer_formula">
                    fertilizer_formula <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="fertilizer_formula" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label" for="brand">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="year_import">
                    year_import <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="year_import" class="form-control" />
                </div>
            </div>
