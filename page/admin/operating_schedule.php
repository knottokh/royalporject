...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_operating_schedule.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>ตาราง operating_schedule</h1>
     <br/>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    <th class="col-right">operate_date</th>
                    <th class="col-right">board_id</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            <div class="form-group">
                    <label class="col-sm-3 control-label" for="operate_date">
                        operate_date <span class="required">*</span> :
                    </label>
                    <div class="col-sm-9">
                        <div class='input-group date' id='operate_date'>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="board_id">
                    board_id <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
