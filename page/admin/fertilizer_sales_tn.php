...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_fertilizer_sales_tn.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>ตาราง fertilizer_sales_tn</h1>
     <br/>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    <th class="col-center">sales_detail</th>
                    <th class="col-center">address_id</th>
                    <th class="col-center">address_moo</th>
                    <th class="col-right">sales_date</th>
                    <th class="col-right">sales_total</th>
                    <th class="col-right">net_total</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            <div class="form-group">
                <label class="col-sm-3 control-label" for="sales_detail">
                    sales_detail <span class="required">*</span> :
                </label>
                <div class="col-sm-9">
                    <textarea rows="5" name="sales_detail" class="form-control"></textarea>
                </div>
            </div>  
            <div class="form-group">
                <label class="col-sm-3 control-label" for="address_id">
                    address_id <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="address_moo">
                    address_moo <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                    <label class="col-sm-3 control-label" for="sales_date">
                        sales_date <span class="required">*</span> :
                    </label>
                    <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="sales_total">
                    sales_total <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="sales_total" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label" for="net_total">
                    net_total <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
