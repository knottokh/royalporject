...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_mill_expense_transf.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>ตาราง mill_expense_transf</h1>
     <br/>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="net">
                    net <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
