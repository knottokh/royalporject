...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_rice.js"></script>
    </head>
<body>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    <th class="col-center">rice_name</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
               <div class="form-group">
                <label class="col-sm-3 control-label" for="rice_name">
                    rice_name <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="rice_name" class="form-control" />
                </div>
            </div>
