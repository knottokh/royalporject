...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/admin/admin_fertilizer_sales_dtl.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>ตาราง fertilizer_sales_dtl</h1>
     <br/>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    <th class="col-right">sales_id</th>
                    <th class="col-right">fertilizer_id</th>
                    <th class="col-right">sales_total</th>
                    <th class="col-right">cost_unit</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            <div class="form-group">
                <label class="col-sm-3 control-label" for="sales_id">
                    sales_id <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="fertilizer_id">
                    fertilizer_id <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="fertilizer_id" class="form-control" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="cost_unit">
                    cost_unit <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="cost_unit" class="form-control" />
                </div>
            </div>
            <div class="form-group">
