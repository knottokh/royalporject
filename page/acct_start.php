...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/page/acct_start.js"></script>
    </head>
<body>
<?php include $rootpath."header.php";?>
    ...
    <div class="kduo-contents">
        <div class="container">
     <h1>กำหนดหมวดบัญชีของแต่ละกองทุน</h1>
     <br/>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">No.</th>
                    ...
                    <th class="col-right">accyear</th>
                    <th class="col-right">accmount</th>
                    <th class="col-center">balance_backward</th>
                    <th class="col-right">balance_tomount</th>
                    <th class="col-right">balance_forward</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="accyear">
                    accyear <span class="required">*</span> :
                </label>
                <div class="col-sm-9">
                    <input type="text" name="accyear" class="form-control" />
                </div>
            </div>
               <div class="form-group">
                <label class="col-sm-3 control-label" for="accmount">
                    accmount <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="accmount" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label" for="balance_backward">
                    balance_backward <span class="required">*</span> :
                </label>
                <div class="col-sm-9">
                    <input type="text" name="balance_backward" class="form-control" />
                </div>
            </div>
               <div class="form-group">
                <label class="col-sm-3 control-label" for="balance_tomount">
                    balance_tomount <span class="required">*</span>:
                </label>
                <div class="col-sm-9">
                    <input type="text" name="balance_tomount" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label" for="balance_forward">
                    balance_forward <span class="required">*</span> :
                </label>
                <div class="col-sm-9">
                    <input type="text" name="balance_forward" class="form-control" />
                </div>
            </div>            
