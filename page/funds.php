...
<html>
    ...
    <?php include $rootpath."scriptref.php";?>
     ...
     <script src="<?=$scriptroot?>js/page/funds.js"></script>
    </head>
<body>
            ...
            <thead>
                <tr>
                   <th data-name="records_no" class="col-center" style="width: 50px">ลำดับ</th>
                    ...
                    <th class="col-center">ประวัติกองทุน</th>
...
<div id="tablesDataTmp" class="hidden">
     <form id="tablesDataForms" name="tablesDataForms" class="form-horizontal" role="form" method="get" action="">
             <div class="form-group">
                <label class="col-sm-3 control-label" for="fund_name">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="history">
                    ประวัติกองทุน :
                </label>
                <div class="col-sm-9">
